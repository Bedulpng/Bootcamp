...
export function ImageCropModal({ isOpen, onClose, imageUrl, onCropComplete, batchId }: ImageCropModalProps) {
        ...
        canvas.toBlob(
          async (blob) => {
            if (blob) {
              ...
              try {
                await axios.post("http://10.10.103.195:4000/uploads/batch-cover", formData, {
                  headers: {
