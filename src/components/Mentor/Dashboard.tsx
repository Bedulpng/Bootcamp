...
export default function MentorDb() {
    ...
    const fetchScheduledClasses = async () => {
      try {
        ...
        const response = await fetch(
          "http://10.10.103.248:4000/mentor/schedule",
          {
            method: "GET",
            headers: {
  ...
  const handleSeeMore = () => {
    // Navigate to /mentor/batch with the My batch filter
    navigate("/mentor/batch?filter=my-batch");
  };
  ...
  useEffect(() => {
    const fetchCompletionPercentages = async () => {
      try {
        ...
        const response = await axios.get(
          "http://10.10.103.248:4000/mentor/completion-percentage",
          {
            headers: {
                ...
                <div className="grid gap-6 md:grid-cols-3">
                  <Card className="bg-sky-400 rounded-2xl shadow-lg">
                    <CardContent className="p-6 flex flex-col items-center justify-between h-[180px]">
                      ...
                      <Link to="/mentor/trainee" className="w-full">
                  ...
                  <Card className="bg-pink-400 rounded-2xl shadow-lg">
                    <CardContent className="p-6 flex flex-col items-center justify-between h-[180px]">
                      ...
                      <Link to="/mentor/batch" className="w-full">
                        <Button className="w-full bg-white text-black hover:bg-gray-100">
                          More
                        </Button>
                      </Link>
