...
export default function MentorDb() {
    ...
    const fetchBatches = async () => {
      try {
        const response = await axios.get(
          "http://192.168.181.104:4000/admin/batch"
  ...
  useEffect(() => {
    ...
    const fetchBatches = async () => {
      try {
        ...
        const response = await axios.get(
          `http://192.168.181.104:4000/admin/batch/${mentorId}`
        );
  ...
  useEffect(() => {
    const fetchCompletionPercentages = async () => {
      try {
        ...
        const response = await axios.get(
          "http://192.168.181.104:4000/mentor/completion-percentage",
          {
            headers: {
  ...
  useEffect(() => {
    const fetchMentorDetails = async () => {
      try {
        ...
        const response = await axios.get(
          `http://192.168.181.104:4000/admin/mentor/${userId}`
        );
  ...
  useEffect(() => {
    const fetchClasses = async () => {
      try {
        const response = await axios.get(
          "http://192.168.181.104:4000/admin/class"
        ); // Replace with your API URL
