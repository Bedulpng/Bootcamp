          ...
          <div className="grid lg:grid-cols-2 gap-4 items-center">
            <motion.div initial="initial" animate="animate" variants={staggerChildren} className="space-y-6 max-w-3xl">
              ...
              <motion.p variants={fadeIn} className="text-xl text-gray-300 max-w-2xl leading-relaxed">
                Master both frontend and backend development with our comprehensive full-stack web development program.
              </motion.p>
            </motion.div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {[
              ...
              },
              {
                ...
                details: [
                  { title: "Duration", text: "24 weeks, flexible schedule with hands-on projects" },
                  { title: "Format", text: "Live online sessions with practical assignments" },
                  { title: "Prerequisites", text: "Basic programming knowledge and problem-solving skills" },
                  { title: "Career Support", text: "Portfolio building and technical interview preparation" },
                ],
              },
            ].map((card, index) => (
              <motion.div
