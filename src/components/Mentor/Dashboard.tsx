  ...
  export default function MentorDb() {
    ...
    useEffect(() => {
      const fetchScheduledClasses = async () => {
        try {
          ...
          const response = await fetch('http://10.10.103.204:4000/mentor/schedule', {
            method: 'GET',
            headers: {
    ...
    useEffect(() => {
      const fetchBatches = async () => {
        try {
          const response = await axios.get('http://10.10.103.204:4000/admin/batch'); // Replace with your API URL
    ...
    useEffect(() => {
      ...
      const fetchBatches = async () => {
        try {
          ...
          const response = await axios.get(`http://10.10.103.204:4000/admin/batch/${mentorId}`);
    ...
    useEffect(() => {
      const fetchCompletionPercentages = async () => {
        try {
          ...
          const response = await axios.get("http://10.10.103.204:4000/mentor/completion-percentage", {
            headers: {
    ...
    useEffect(() => {
      const fetchClasses = async () => {
        try {
          const response = await axios.get('http://10.10.103.204:4000/admin/class'); // Replace with your API URL
