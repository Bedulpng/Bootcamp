...
export default function NavbarMentor() {
  ...
  const navItems = [
    { path: '/dashboardm', label: 'Dashboard' },
    { path: '/dashboardm/batch', label: 'Explore Batch' },
    { path: '/dashboardm/trainee', label: 'Trainee' },
  ]
  ...
  return (
    <header className="border-b">
      <div className="container relative flex h-16 items-center px-8 justify-between">
        {/* Logo */}
        <Link to="/dashboardm" className="flex-shrink-0">
          <img
