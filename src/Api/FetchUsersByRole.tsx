...
export async function fetchTrainees(): Promise<Trainee[]> {
  try {
    const response = await axios.get('http://192.168.181.104:4000/admin/users/TRAINEE');
...
export async function fetchMentors(): Promise<Trainee[]> {
  try {
    const response = await axios.get('http://192.168.181.104:4000/admin/users/MENTOR');
    return response.data;
  } catch (error) {
