  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        ...
        <UserModalEdit open={isEditUserOpen} setOpen={setIsEditUserOpen} id={selectedUserId} fullName={fullName} />
        <DeleteUserModal isOpen={isDeleteUserOpen} id={selectedUserId} fullName={fullName} onClose={handleCloseUserDelete}/>
      </div>
