...
export default function MentorDb() {
    ...
    const fetchScheduledClasses = async () => {
      try {
        ...
        const response = await fetch(
          "http://10.10.103.127:4000/mentor/schedule",
          {
            method: "GET",
            headers: {
    ...
    const fetchBatches = async () => {
      try {
        const response = await axios.get(
          "http://10.10.103.127:4000/admin/batch"
  ...
  useEffect(() => {
    ...
    const fetchBatches = async () => {
      try {
        ...
        const response = await axios.get(
          `http://10.10.103.127:4000/admin/batch/${mentorId}`
        );
  ...
  useEffect(() => {
    const fetchCompletionPercentages = async () => {
      try {
        ...
        const response = await axios.get(
          "http://10.10.103.127:4000/mentor/completion-percentage",
          {
            headers: {
  ...
  useEffect(() => {
    const fetchMentorDetails = async () => {
      try {
        ...
        const response = await axios.get(
          `http://10.10.103.127:4000/admin/mentor/${userId}`
        );
        ...
        const profileResponse = await axios.get(
          `http://10.10.103.127:4000/trainee/${userId}/pro`
        );
  ...
  useEffect(() => {
    const fetchClasses = async () => {
      try {
        const response = await axios.get(
          "http://10.10.103.127:4000/admin/class"
        ); // Replace with your API URL
                    ...
                    <div className="text-center flex-1 flex flex-col items-center justify-center">
                      <div className="w-17 h-17 rounded-full border-2 border-gray-200 flex items-center justify-center mb-6">
                        <Avatar className="h-16 w-16 border-gray-800 rounded-full">
                          <AvatarImage
                            src={`http://10.10.103.127:4000${profileImage}`}
                            alt="Mentor"
                          />
                          <AvatarFallback>
                            {mentorName
